...
int findDetInverse(int R , int D = 26) //3// R is the remainder or determinant
{
	int i = 0 ;
	int p[100] = {0,1};
...
/* Inverse = (adj of matrix * detInverse) mod 26 */
/* findInverse(key matrix , order_of_matrix , result_matrix) */
void findInverse(int m[3][3] , int n , int m_inverse[3][3] )//5
{
	int adj[3][3] = {0};
